...
go get -v github.com/projectdiscovery/subfinder/cmd/subfinder > /dev/null;
...
sudo wget https://github.com/Edu4rdSHL/findomain/releases/latest/download/findomain-linux > /dev/null 2>&1;
...
sudo mkdir $HOME/recon/tools/assertfinder;

cd $HOME/recon/tools/assertfinder;
...
sudo mkdir $HOME/recon/tools/aquatone;
...
sudo unzip aquatone_linux_amd64_1.7.0.zip > /dev/null 2>&1;
